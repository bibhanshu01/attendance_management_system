<?php
 ...
 // $studentName = $_SESSION['userName'];
  ...
  //     $datestatus = true;
  //     $date = $_POST['date'];
  //     $attendanceQuery = "SELECT * FROM attendance WHERE studentID = '$studentID' AND attendanceDate = '$date'";
  //   }
...
<form>
  <label><input type="radio" name="attendancer" value="subjectr" onclick="showSubjectForm()">Subject</label>
  <label><input type="radio" name="attendancer" value="dater" onclick="showDateForm()">Date</label>
</form>
